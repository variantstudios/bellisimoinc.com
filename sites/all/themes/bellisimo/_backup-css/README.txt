...
To use these stylesheets, rename the files and bellisimo with the name of your theme.
...
bellisimo-alpha-default-narrow.css  
...
bellisimo-alpha-default-normal.css
...
bellisimo-alpha-default-wide.css
